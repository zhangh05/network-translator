...
| CI gate (--full) | **1970 passed / 0 known tolerated / 10 skipped** |
| 全量测试 (`pytest tests/`) | **2495 passed / 0 failed / 29 skipped** |
...
| Batch O 模块扩展 | ✅ PASS | 2026-06-02 |
| Batch O 语料评估 | ✅ PASS | 2026-06-02 |
| Batch O 安全不变量 | ✅ PASS | 2026-06-02 |
